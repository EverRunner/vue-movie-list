      ...
      <div class="movie-info">
        ...
        <div class="movie-details">
          <div class="movie-header">
            ...
            <div class="bookmark-button" @click="toggleBookmark">
              {{ movie.bookmarked ? '★' : '☆' }}
            </div>
          </div>
...
function toggleBookmark() {
  ...
  if (movieId) {
    movieStore.toggleBookmark(movieId);
    emit('bookmark-toggled', movieId);
  }
  // Optionally, persist the bookmark state here
}
</script>
